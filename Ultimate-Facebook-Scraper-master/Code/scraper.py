    ...
    try:
        ...
        try:
            ...
            if platform_ in ['linux', 'darwin']:
                driver = webdriver.Chrome(executable_path="/home/moussa/Téléchargements/chromedriver_linux64/chromedriver", options=options)
            else:
                driver = webdriver.Chrome(executable_path="/home/moussa/Téléchargements/chromedriver_linux64/chromedriver/chromedriver.exe", options=options)
        except:
        ...
        # filling the formhttps://www.facebook.com/andrew.ng.96
...
def main():
    with open('/home/moussa/Documents/PROJET/projethtml/web&scrapping/credentials.txt') as f:
    ...
    ids = ["https://en-gb.facebook.com/" + line.split("/")[-1] for line in open("/home/moussa/Documents/PROJET/projethtml/web&scrapping/input.txt", newline='\n')]
